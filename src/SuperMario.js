...
import SuperMario2 from './SuperMario2';

function SuperMario({ volume, directionFromJoycon }) {
  console.log("directionFromJoycon", directionFromJoycon);
...
const [isMuted, setIsMuted] = useState(false);
  ...
  const [coins, setCoins] = useState([
    ...
    { id: 2, x: 500, y: 100 },
    { id: 3, x: 860, y: 100 },
    // { id: 4, x: 400, y: 220 }, // on top of brick 1
  ...
  const move = dir => {
    ...
    const newX = Math.min(970, Math.max(0, position.x + delta));
  ...
  return (
    <div className="super-mario-screen">
      ...
      <audio
        ...
        preload="auto"
      />
      <audio ref={audioRef} src="/assets/super_mario_bros.mp3" loop />
      <audio
        ref={victoryAudioRef}
      ...
      {isLoading ? (
        ...
        <div className="main-game-assets">
          <h1 className="super-heading">LEVEL 1</h1>
          ...
          {isGameOver && (
            <>
              ...
              <img
                ...
                alt="Game Over"
                  className={`game-over-gif ${isGameOver ? 'mario-death-animation' : ''}`}
                style={{
              ...
              <>
                ...
                <div className="victory-popup">
                  ...
                  <img
                    ...
                    onClick={handleRestart}
                  />
                  <div className="next-level-button" onClick={handleNextLevel}>
                    Next Level
                  </div>
                </div>
              </>
          ...
          <img src="/assets/flag-mario.png" className="flag" alt="Flag" />
